The instanceof operator is a better alternative to is_object(). instanceof checks for an variable to be of a class or its parents or the interfaces it implements. 
