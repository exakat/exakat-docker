...
[Docker](https://www.docker.com) container to install and run [Exakat](https://www.exakat.io/) 2.0.1.

## Features

* [Exakat](https://www.exakat.io/) [`2.0.1`](https://github.com/exakat/exakat.git)
* [PHP](https://php.net) 7.3
* [Gremlin Server 3.4.3](http://tinkerpop.apache.org/)
...
2. Build the container:
    ...
    ``` sh
	$ docker build --no-cache -t exakat/exakat:2.0.1 .
    ```
