...
[Docker](https://www.docker.com) container to install and run [Exakat](https://www.exakat.io/) 1.3.2.

## Features

* [Exakat](https://www.exakat.io/) [`1.3.2`](https://github.com/exakat/exakat.git)
