...
[Docker](https://www.docker.com) container to install and run [Exakat](https://www.exakat.io/) 1.5.3.

## Features

* [Exakat](https://www.exakat.io/) [`1.5.3`](https://github.com/exakat/exakat.git)
