...
[Docker](https://www.docker.com) container to install and run [Exakat](https://www.exakat.io/) 1.9.9.

## Features

* [Exakat](https://www.exakat.io/) [`1.9.9`](https://github.com/exakat/exakat.git)
