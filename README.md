...
[Docker](https://www.docker.com) container to install and run [Exakat](https://www.exakat.io/) 1.7.6.

## Features

* [Exakat](https://www.exakat.io/) [`1.7.6`](https://github.com/exakat/exakat.git)
