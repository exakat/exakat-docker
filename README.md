...
[Docker](https://www.docker.com) container to install and run [Exakat](https://www.exakat.io/) 2.1.4.

## Features

* [Exakat](https://www.exakat.io/) [`2.1.4`](https://github.com/exakat/exakat.git)
* [PHP](https://php.net) 7.4
* [Gremlin Server 3.4.7](http://tinkerpop.apache.org/)
...
2. Build the container:
    ...
    ``` sh
	$ docker build --no-cache -t exakat/exakat:2.1.4 .
    ```
